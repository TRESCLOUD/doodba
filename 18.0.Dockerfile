...
RUN build_deps=" \
    ...
    # Modificado versiones de python para permitir compatibilidad con 3.12
    && sed -i '/^gevent==/d;/^greenlet==/d' requirements.txt \
    && pip install gevent==23.9.1 greenlet==3.0.3 \
